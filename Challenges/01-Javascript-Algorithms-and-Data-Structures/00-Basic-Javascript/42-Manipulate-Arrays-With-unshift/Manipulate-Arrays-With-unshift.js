/*
    ...
    beginning of an array i.e. add elements in front of 
    the array.
    -------------------------------------------------------
    `.unshift()` works exactly like `.push()`, but instead 
    of adding the element at the end of the array, 
    `.unshift()` adds the element at the beginning of the 
    array.
    -------------------------------------------------------
